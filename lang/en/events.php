...
return [
    ...
    'wait_for_approval_text' => 'This event has not been approved yet. It is still editable (by admin and rector) until approved.',
    'wait_for_approval_and_location_text' => 'This event has not been approved yet. It is still editable (by admin and rector) until approved. The location must be set before approval.',
    'review' => 'Review',
    ...
    'wait_for_publishing_text' => 'This event has been approved but it has not been published yet. In this stage participants can already be added from this page.',
    'published_text' => 'This event has been approved and published. You can still edit some details.',
    'has_been_published_text' => 'This event has been approved and published.',
    'publish' => 'Publish',
    ...
    'event_academy_participants_tooltip' => 'Active academy\'s users with paid fee.',
    'event_nation_participants_tooltip' => 'Active users in academies of the same nation, with paid fee.',
    'event_admin_participants_tooltip' => 'Active users.',
    'event_others_participants_tooltip' => 'Active users with paid fee.',

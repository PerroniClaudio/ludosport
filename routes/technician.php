...
Route::prefix('technician')->middleware(['auth', 'minor.approved', 'role.institution.selected'])->middleware('role:admin,technician')->group(function () {

    /** Users */

    Route::group([], function () {
        Route::get('/users', [App\Http\Controllers\PaginatedUserController::class, 'index'])->name('technician.users.index');

...
Route::prefix('rector')->middleware(['auth', 'minor.approved', 'role.institution.selected', 'role:admin,rector'])->group(function () {
  ...
  Route::group([], function () {
    ...
    Route::get('/users/{user}/document-history/{history}', [App\Http\Controllers\UserController::class, 'downloadMinorApprovalDocumentHistory'])->name('rector.users.document-history.download');
    ...
    Route::post('/user-roles/{user}', [App\Http\Controllers\UserController::class, 'updateRoles'])->name('rector.users.roles-update');

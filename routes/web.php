...
Route::group(['middleware' => ['auth', 'role:admin']], function () {
    ...
    Route::get('/rank-requests/{rankRequest}/approve', [App\Http\Controllers\RankController::class, 'acceptRequest'])->name('rank-requests.approve');
    Route::get('/rank-requests/{rankRequest}/reject', [App\Http\Controllers\RankController::class, 'rejectRequest'])->name('rank-requests.reject');
    Route::get('/rank-requests/{rankRequest}/delete', [App\Http\Controllers\RankController::class, 'deleteRequest'])->name('rank-requests.delete');

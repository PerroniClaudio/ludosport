...
Route::get('/weapon-form/{weapon:id}/{variant}/image', [App\Http\Controllers\AssetController::class, 'weaponFormVariantImage'])->name('weapon-form-variant-image');
...
Route::group(['middleware' => ['auth', 'privacy.policy', 'role.institution.selected', 'role:admin']], function () {
    ...
    Route::post('/weapon-forms/{weaponForm}/technicians', [App\Http\Controllers\WeaponFormController::class, 'addTechnicians'])->name('weapon-forms.technicians.store');

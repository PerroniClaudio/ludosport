...
Route::prefix('dean')->middleware(['auth', 'minor.approved', 'role.institution.selected'])->middleware('role:admin,dean')->group(function () {
  ...
  Route::group([], function () {
    ...
    Route::get('/filtered-by-dashboard', [App\Http\Controllers\PaginatedUserController::class, 'usersFilteredByActiveAndCoursePagination'])->name('dean.users.filtered-by-active-and-course');
    ...
    Route::post('/user-roles/{user}', [App\Http\Controllers\UserController::class, 'updateRoles'])->name('dean.users.roles-update');
    ...
    Route::post('/users/{user}/weapon-forms-athlete', [App\Http\Controllers\UserController::class, 'editWeaponFormsAthlete'])->name('dean.user.weapon-forms-athlete.store');
    Route::post('/users/{user}/weapon-forms-edit-date', [App\Http\Controllers\UserController::class, 'editWeaponFormsAwardingDate'])->name('dean.user.weapon-forms-edit-date');
  });

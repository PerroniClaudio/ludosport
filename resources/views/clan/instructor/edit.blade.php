<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col gap-4">
            ...
            <div class="bg-white dark:bg-background-800 overflow-hidden shadow-sm sm:rounded-lg p-8">
                <form method="POST" action="{{ route('instructor.clans.update', $clan->id) }}">
                    @csrf
                    <div class="flex flex-col gap-2 w-1/2">
                        ...
                        <x-clan.weapon-form :selected_weapon="$clan->weaponform" :available_weapons="$available_weapons" disabled="{{true}}" />

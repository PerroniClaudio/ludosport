    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" x-data="{
            ...
            getAvailableSchools: function() {
                ...
                fetch(`/instructor/schools/academy?${params}`)
            ...
            getAvailableCourses: function() {
                ...
                fetch(`/instructor/courses/school?${params}`)
                    .then(response => response.json())
                    .then(data => {
            ...
            <form action="{{ route('instructor.users.filter.result') }}" method="GET" class="flex flex-col gap-2">
                ...
                <div class="bg-white dark:bg-background-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-background-900 dark:text-background-100 flex flex-col gap-2">
                        ...
                        <x-form.radio-group name="fee_status" label="{{ __('users.filter_by_fee') }}" :options="['fee' => 'Paid', 'fee_not_paid' => 'Not paid']" selected="" />
                    </div>
                </div>

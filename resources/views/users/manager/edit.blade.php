{{-- 
    Manager cannot assign roles higher than his own.
--}}
@php
    $no_access_roles = ['admin', 'rector', 'dean'];
@endphp
<x-app-layout>
    <x-slot name="header">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('manager.users.update', $user->id) }}" class="grid grid-cols-2 gap-4">
                @csrf

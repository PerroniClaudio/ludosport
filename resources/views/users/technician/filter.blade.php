    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" x-data="{
            ...
            getAvailableSchools: function() {
                ...
                fetch(`/technician/schools/academy?${params}`)
            ...
            getAvailableCourses: function() {
                ...
                fetch(`/technician/courses/school?${params}`)
                    .then(response => response.json())
                    .then(data => {
            ...
            <form action="{{ route('technician.users.filter.result') }}" method="GET" class="flex flex-col gap-2">

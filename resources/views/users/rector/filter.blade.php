    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" x-data="{
            ...
            getAvailableSchools: function() {
                ...
                fetch(`/rector/schools/academy?${params}`)
            ...
            getAvailableCourses: function() {
                ...
                fetch(`/rector/courses/school?${params}`)
                    .then(response => response.json())
                    .then(data => {
            ...
            <form action="{{ route('rector.users.filter.result') }}" method="GET" class="flex flex-col gap-2">

...
<div x-data="{
    ...
    <x-primary-button x-on:click.prevent="$dispatch('open-modal', 'handpick-athlete-modal')">
        <x-lucide-plus class="w-6 h-6 text-white" />
    </x-primary-button>

    <x-modal name="handpick-athlete-modal" :show="$errors->userId->isNotEmpty()" focusable>
        <div class="p-6">

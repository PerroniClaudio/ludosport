...
@endphp
<div x-load x-data="usernationgraphadmin('{{ $authRole }}')">
                ...
                <div class="flex flex-col gap-8">
                    <div class="flex flex-col gap-4 grow">
                            ...
                            <template x-for="nation in paginatedNations" :key="nation.id">
                                <li class="flex items-center gap-4">
                                    <div class="grow flex justify-between">
                                        ...
                                        <span x-text="getMetricValue(nation)"></span>
                                    </div>
                        ...
                        <div class="flex justify-between ">
                            ...
                            <span>Page <span x-text="currentNationsPage"></span> of <span
                                    x-text="totalNationsPages"></span></span>
                            <x-primary-button-small @click="nextPage"
                                x-bind:disabled="currentNationsPage === totalNationsPages">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div class="p-4 bg-background-100 dark:bg-background-700 rounded-lg">
                            ...
                            <p class="text-primary-600 dark:text-primary-500 text-3xl" x-text="worldYearData.last_year">
                            </p>
                        </div>
                        <div class="p-4 bg-background-100 dark:bg-background-700 rounded-lg">
                            <p>{{ __('dashboard.rector_users_this_year') }}</p>
                            <p class="text-primary-600 dark:text-primary-500 text-3xl" x-text="worldYearData.this_year">
                            </p>
                        </div>
                    </div>
                </div>

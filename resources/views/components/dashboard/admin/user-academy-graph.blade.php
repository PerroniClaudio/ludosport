...
@endphp
<div x-data="useracademygraphadmin('{{ $authRole }}', {{ $nation }}, {{ $selectedNationData }})">
                ...
                <div class="flex flex-col gap-8">
                    <div class="flex flex-col gap-4 grow">
                        <div class="flex justify-between">
                            <h3 class="text-background-800 dark:text-background-200 text-lg">
                                {{ __('dashboard.rector_academies_with_athletes_char') }}
                            </h3>
                            <button @click="$data.setLevel('world');" 
                        ...
                        <div class="flex justify-between ">
                            ...
                            <span>Page <span x-text="currentAcademiesPage"></span> of <span x-text="totalAcademiesPages"></span></span>
                            <x-primary-button-small @click="nextPage" x-bind:disabled="currentAcademiesPage === totalAcademiesPages">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div class="p-4 bg-background-100 dark:bg-background-700 rounded-lg">
                            ...
                            <p class="text-primary-600 dark:text-primary-500 text-3xl" x-text="nationYearData.last_year"></p>
                        </div>
                        <div class="p-4 bg-background-100 dark:bg-background-700 rounded-lg">
                            <p>{{ __('dashboard.rector_users_this_year') }}</p>
                            <p class="text-primary-600 dark:text-primary-500 text-3xl" x-text="nationYearData.this_year"></p>
                        </div>
                    </div>
                </div>
            </div>

...
@endphp
<div x-data="usercoursegraphadmin('{{ $authRole }}', {{ $school }}, {{ $selectedSchoolData }})">

    <div class="bg-white dark:bg-background-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-background-900 dark:text-background-100">
            <h3 class="text-background-800 dark:text-background-200 text-2xl">
                {{ __('dashboard.rector_athletes_courses_title') }}, <span x-text="school.name"></span> 
            </h3>
                ...
                <div class="flex flex-col gap-8">
                    <div class="flex flex-col gap-4 grow">
                        <div class="flex justify-between">
                            <h3 class="text-background-800 dark:text-background-200 text-lg">
                                {{ __('dashboard.rector_courses_with_athletes_char') }}
                            </h3>
                            <button @click="$data.setLevel('academy');" 
                        ...
                        <div class="flex justify-between ">
                            ...
                            <span>Page <span x-text="currentCoursesPage"></span> of <span x-text="totalCoursesPages"></span></span>
                            <x-primary-button-small @click="nextPage" x-bind:disabled="currentCoursesPage === totalCoursesPages">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div class="p-4 bg-background-100 dark:bg-background-700 rounded-lg">
                            ...
                            <p class="text-primary-600 dark:text-primary-500 text-3xl" x-text="schoolYearData.last_year"></p>
                        </div>
                        <div class="p-4 bg-background-100 dark:bg-background-700 rounded-lg">
                            <p>{{ __('dashboard.rector_users_this_year') }}</p>
                            <p class="text-primary-600 dark:text-primary-500 text-3xl" x-text="schoolYearData.this_year"></p>
                        </div>
                    </div>
                </div>
            </div>

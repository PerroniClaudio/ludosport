...
@endphp
<div x-load x-data="userschoolgraphadmin('{{ $authRole }}', {{ $academy }}, {{ $selectedAcademyData }})">
                    ...
                    <div class="flex flex-col gap-4 grow">
                        <div class="flex justify-between">
                            <h3 class="text-background-800 dark:text-background-200 text-lg">
                                {{ __('dashboard.schools_with_athletes_char') }}
                            </h3>
                            <button @click="$data.setLevel('nation');" class="p-1 bg-primary-500 rounded">
                            ...
                            <template x-for="school in paginatedSchools" :key="school.id">
                                <li class="flex items-center gap-4">
                                    <div class="grow flex justify-between">
                                        ...
                                        <span x-text="getMetricValue(school)"></span>
                                    </div>
                        ...
                        <div class="flex justify-between ">
                            ...
                            <span>Page <span x-text="currentSchoolsPage"></span> of <span
                                    x-text="totalSchoolsPages"></span></span>
                            <x-primary-button-small @click="nextPage"
                                x-bind:disabled="currentSchoolsPage === totalSchoolsPages">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div class="p-4 bg-background-100 dark:bg-background-700 rounded-lg">
                            ...
                            <p class="text-primary-600 dark:text-primary-500 text-3xl"
                                x-text="academyYearData.last_year"></p>
                        </div>
                        <div class="p-4 bg-background-100 dark:bg-background-700 rounded-lg">
                            <p>{{ __('dashboard.rector_users_this_year') }}</p>
                            <p class="text-primary-600 dark:text-primary-500 text-3xl"
                                x-text="academyYearData.this_year"></p>
                        </div>
                    </div>
                </div>
            </div>

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col gap-4">
            <div class="bg-white dark:bg-background-800 overflow-hidden shadow-sm sm:rounded-lg p-8">
                ...
                <div class="flex flex-col gap-2 w-1/2">
                    ...
                    <x-form.textarea name="description" label="Description" required="{{ true }}"
                        value="{{ $event->description }}" placeholder="{{ fake()->sentence() }}" />
            ...
            <div class="bg-white dark:bg-background-800 overflow-hidden shadow-sm sm:rounded-lg p-8">
                <h3 class="text-background-800 dark:text-background-200 text-2xl">{{ __('events.promo') }}</h3>
                <div class="border-b border-background-100 dark:border-background-700 my-2"></div>
                <x-editor name="promo" value="{{ $event->description }}" />
            </div>

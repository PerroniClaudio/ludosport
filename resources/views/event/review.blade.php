    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col gap-4">
            <div class="bg-white dark:bg-background-800 overflow-hidden shadow-sm sm:rounded-lg p-8">
                <h1 class="font-semibold text-3xl text-background-800 dark:text-background-200 leading-tight">{{ $event->name }}</h1>
                ...
                <section class="grid grid-cols-2 gap-4 my-8">
                    <div class="flex flex-col gap-2 bg-background-700 rounded-lg p-8">
                        ...
                        <h2 class="font-semibold text-2xl text-background-800 dark:text-background-200 leading-tight">{{ __('events.info') }}</h2>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-background-200 font-4xl">{{ $event->address }}, {{ $event->postal_code }} {{ $event->city }}, {{ $event->nation->name }}</span>
                        </div>
                        <div class="flex items-center gap-2">
                            @php 

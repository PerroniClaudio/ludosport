<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div>
                <x-create-new-button :href="route('rector.events.create')" />
            </div>
        </div>
    </x-slot>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col gap-4" x-script-element="calendar" x-load x-data="calendar('{{ route('rector.events.calendar') }}')">
                                ...
                                <x-table striped="false" :columns="[
                                    ...
                                    <x-slot name="tableRows">
                                        ...
                                        <td
                                            ...
                                            <a x-bind:href="'/rector/events/' + row.id">
                                                <x-lucide-pencil

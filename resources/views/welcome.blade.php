    ...
    <style>
        ...
        *,
        ...
        .drop-shadow-\[0px_4px_34px_rgba\(0\2c 0\2c 0\2c 0\.06\)\] {
            ...
            filter: var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-backgroundscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow)
        }
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="bg-background-50 text-black/50 dark:bg-black dark:text-white/50">

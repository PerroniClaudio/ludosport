...
class PrivacyPolicyController extends Controller
{
    ...
    /**
     * Aggiorna il contenuto della privacy policy
     */
    public function update(UpdatePrivacyPolicyRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('privacy-policy.edit')
            ->with('success', __('privacy_policy.updated_successfully'));
    }

    /**
     * Mostra la privacy policy attiva (pubblica)
     */
    ...
    /**
     * Registra l'accettazione della privacy policy
     */
    ...
    /**
     * Rifiuta la privacy policy e sloggazione
     */
    public function decline(): RedirectResponse
    {
        ...
        return redirect('/')->with('message',
            __('privacy_policy.acceptance_required'));
    }
}
